...
lwPopups = (function () {
   ...
   Mp4Video = function (id, windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {

        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.url = url === undefined ? DefaultValuesMap.DEFAULT_IMAGE_URL : url;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<video controls width="600"><source src="' + this.url + '" type="video/mp4"></video>');
            return undefined;
        };
        ...
        this.autoscale = function () {
            $('#popUpInnerContainer-' + id).css('width', '');
        };

        // TODO RefactorMe: get rid of the busy polling
        // Problem: There is no callback for when the browser is done
        // loading the image! Probably need to load via AJAX.
        this.imageHasLoaded = function () {
            var _this = this;
            if ($('#lwpopups-img-' + this.id).width() === 0) {
                setTimeout(function () {_this.imageHasLoaded(); }, 50);
            } else {
                $('#popUp-' + id).css('opacity', '');
                $('#popUp-' + id).css('display', 'none');
                this.show();
            }
        };

        $('#popUp-' + id).css('opacity', '0.001');
        $('#popUp-' + id).css('display', '');

        this.imageHasLoaded();
    };

    Mp4Video.prototype = new AbstractBaseWindow();
     ...
     * @return undefined
     */
    ImageWindow = function (id, windowTitle, imageURL, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {

        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.imageURL = imageURL === undefined ? DefaultValuesMap.DEFAULT_IMAGE_URL : imageURL;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<img id="lwpopups-img-' + id + '" src="' + this.imageURL + '" style="max-height:85vh;display:block;margin:auto" alt />');
            return undefined;
        };
    ...
    ImageWindow.prototype = new AbstractBaseWindow();
    ...
    var AbstractIFrameWindow;

    /**
     * Abstract IFrame Window Class.
     *
     * @private
     * @abstract
     * @class AbstractIFrameWindow
     */
    AbstractIFrameWindow = function () { return undefined; };

    // TODO RefactorMe
    AbstractIFrameWindow.prototype = {
        devNull : ""
    };

    AbstractIFrameWindow.prototype = new AbstractBaseWindow();
     ...
     * @return undefined
     */
    YouTubeWindow = function (id, windowTitle, youtubeVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        this.position = position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
        this.displayDuration_sec = displayDuration_sec;

        this.youtubeVideoID = youtubeVideoID === undefined ? undefined : youtubeVideoID;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="lwpopups-youtube-frame-' + id + '" src="https://www.youtube.com/embed/' + this.youtubeVideoID + '?autoplay=1&amp;loop=1&amp;playlist=' + this.youtubeVideoID + '&wmode=transparent&mute=1" width="600" height="450" style="border-width:0px;margin:0 auto;display:block">&lt;br/&gt;</iframe>');
        };

        this.setContent();

        this.autoscale = function () {
            // TODO ImplementMe so that I'm useful
            $('#popUpInnerContainer-' + id).css('width', '615px');
        };

        this.show();
    };

    YouTubeWindow.prototype = new AbstractIFrameWindow();


 var TwitchWindow;

    TwitchWindow = function (id, windowTitle, twitchID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        this.twitchID = twitchID === undefined ? undefined : twitchID;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="lwpopups-youtube-frame-' + id + '" src="https://embed.twitch.tv?channel=' + twitchID + '&amp;layout=video&amp;parent=' + window.location.href.substring(8).slice(0, -1) + '&amp;referrer=' + window.location.href + '&amp;width=600&amp;height=450" width="600" height="450" style="border-width:0px;margin:0 auto;display:block">&lt;br/&gt;</iframe>');
        };
    ...
    TwitchWindow.prototype = new AbstractIFrameWindow();



    var RumbleWindow;

    RumbleWindow = function (id, windowTitle, rumbleVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        this.rumbleVideoID = rumbleVideoID === undefined ? undefined : rumbleVideoID;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="lwpopups-rumble-frame-' + id + '" src="https://rumble.com/embed/' + this.rumbleVideoID +'/?pub=7a20&autoplay=2" width="600" height="450" style="border-width:0px;margin:0 auto;display:block">&lt;br/&gt;</iframe>');
        };
    ...
    RumbleWindow.prototype = new AbstractIFrameWindow();


    var Tweetwindow;

    TweetWindow = function (id, windowTitle, tweetId, tweetHeight, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        this.tweetId = tweetId === undefined ? undefined : tweetId;
	this.tweetHeight = tweetHeight;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="" style="position: static;visibility: visible;width: 520px;display: block;flex-grow: 1;height: ' + this.tweetHeight + 'px;padding: 10px 0 0 35px;" title="Twitter Tweet" src="https://platform.twitter.com/embed/Tweet.html?dnt=false&amp;embedId=twitter-widget-0&amp;id=' + this.tweetId + '&amp;theme=dark&amp;width=520px" data-tweet-id="' + this.tweetId + '" </iframe>');
        };
    ...
    TweetWindow.prototype = new AbstractIFrameWindow();
     ...
     * @return undefined
     */
    URLWindow = function (id, windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        // TODO remove demo string -> undefined or so?
        this.url = url === undefined ? "http://www.google.com/" : url;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="lwpopups-url-frame-' + id + '" src="' + this.url + '" style="border-width:0px;margin:0 auto;display:block">&lt;br/&gt;</iframe>');
        };
        ...
        this.autoscale = function () {
            // TODO ImplementMe so that I'm useful
            var scrollBarMarginPX = 14;
            $('#popUpInnerContainer-' + id).css('width', '640px');
            $('#lwpopups-url-frame-' + id).css('width', 640 - scrollBarMarginPX + 'px');
            $('#lwpopups-url-frame-' + id).css('height', '480px');
        };

        this.show();
    };

    URLWindow.prototype = new AbstractIFrameWindow();



var BandcampWindow;

    BandcampWindow = function (id, windowTitle, bandcampContent, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        this.id = id;
        this.windowTitle = windowTitle === undefined ? DefaultValuesMap.DEFAULT_WINDOW_TITLE : windowTitle;
        this.position = position === undefined ? DEFAULT_POSITION : position;
        this.forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed === undefined ? false : forbidMoreInstancesUntilClosed;
        ...
        // TODO remove demo string -> undefined or so?
        this.bandcampContent = bandcampContent === undefined ? "undefined" : bandcampContent;
        ...
        this.setContent = function () {
            $('#popUpContent-' + id).html('<div class="popUpFocusMask" style="display:none;position:absolute;height:100%;width:100%"></div><iframe id="lwpopups-url-frame-' + id + '" style="border: 0; width: 600px; height: 740px;" src="https://bandcamp.com/EmbeddedPlayer/album=' + this.bandcampContent + '/size=large/bgcol=181a1b/linkcol=056cc4/tracklist=false/transparent=true/" seamless"></iframe>');
        };
        ...
        this.autoscale = function () {
            ...
            $('#popUpInnerContainer-' + id).css('width', '640px');
            $('#lwpopups-url-frame-' + id).css('width', 640 - scrollBarMarginPX + 'px');
            $('#lwpopups-url-frame-' + id).css('height', '740px');
        };

        this.show();
    };

    BandcampWindow.prototype = new AbstractIFrameWindow();
    ...
    windowManager = (function () {
         ...
         * @return undefined
         */
        function showImage(windowTitle, imageURL, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                ...
                w = new ImageWindow(WPOPUPS_GLOBAL_id, windowTitle, imageURL, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }
	 ...
	 * @param {string} textColor
         ...
         * @return undefined
         */
        function showURL(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new URLWindow(WPOPUPS_GLOBAL_id, windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }
         ...
         * @return undefined
         */
        function showYouTubeVideo(windowTitle, youtubeVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new YouTubeWindow(WPOPUPS_GLOBAL_id, windowTitle, youtubeVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }

        function showTwitchVideo(windowTitle, twitchID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new TwitchWindow(WPOPUPS_GLOBAL_id, windowTitle, twitchID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }

        function showRumbleVideo(windowTitle, rumbleVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new RumbleWindow(WPOPUPS_GLOBAL_id, windowTitle, rumbleVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }

        function showMp4Video(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new Mp4Video(WPOPUPS_GLOBAL_id, windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }

        function showTweetWindow(windowTitle, tweetId, tweetHeight, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new TweetWindow(WPOPUPS_GLOBAL_id, windowTitle, tweetId, tweetHeight, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }

        function showBandcampWindow(windowTitle, bandcampContent, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
            if ((!ALLOW_UNLIMITED_WINDOWS && WPOPUPS_GLOBAL_openWindows >= IF_FALSE_ALLOW_UNLIMITED_WINDOWS_THEN_MAX_OPEN_WINDOWS) || WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed) {
                _thisPopUps.shakeAll();
            } else {
                WPOPUPS_GLOBAL_forbidMoreInstancesUntilClosed = forbidMoreInstancesUntilClosed;
                w = new BandcampWindow(WPOPUPS_GLOBAL_id, windowTitle, bandcampContent, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
                windowQueue.push(w);
            }
            return undefined;
        }
	    ...
	    showTwitchVideo : showTwitchVideo,
    ...
    /**
     * Shows a window that contains an image.
     *
     * @method lwPopups.showImage
     * @param {string} [windowTitle="Info"] The Window Title.
     * @param {string} [imageURL] Image to show.
     ...
     */
    function showImage(windowTitle, imageURL, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showImage(windowTitle, imageURL, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }
    ...
    /**
     * Shows a window that contains an URL iFrame.
     *
     * @method lwPopups.showURL
     * @param {string} [windowTitle="Info"] The Window Title.
     ...
     */
    function showURL(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showURL(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }

    /**
     * Shows a window that contains a Youtube video.
     *
     * @method lwPopups.showYouTubeVideo
     * @param {string} [windowTitle="Info"] The Window Title.
     * @param {string=} youtubeVideoID Equals THE_ID in YouTube URL "...watch?v=THE_ID".
     * @param {number} [position=Position.CENTER] One of the values specified in Position.
     * @param {boolean} [forbidMoreInstancesUntilClosed=false] If true no more popups are created until this one is closed.
     * @param {number=} [displayDuration_sec] Duration until the window fades out automatically and is destroyed.
     * @return undefined
     */
    function showYouTubeVideo(windowTitle, youtubeVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showYouTubeVideo(windowTitle, youtubeVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }

    function showTwitchVideo(windowTitle, twitchID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showTwitchVideo(windowTitle, twitchID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }

    function showRumbleVideo(windowTitle, rumbleVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showRumbleVideo(windowTitle, rumbleVideoID, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }

    function showMp4Video(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showMp4Video(windowTitle, url, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }

    function showTweetWindow(windowTitle, tweetId, tweetHeight, position, forbidMoreInstancesUntilClosed, displayDuration_sec) {
        windowManager.showTweetWindow(windowTitle, tweetId, tweetHeight, position, forbidMoreInstancesUntilClosed, displayDuration_sec);
        return undefined;
    }
